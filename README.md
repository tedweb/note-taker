...
In today's work-from-anywhere world, keeping everything organized is a challenge. Scribe works to simplify one aspect of our everyday work lives... our notes.  We all take them.  We all need them.  Let's organize them!  Scribe follows the  '*Less Is More*' mentality.  No GUI interface, just a simple command line that can be launched from an icon on your desktop.
